...
public class RefactoringPage4 extends BaseRefactoringPage {
	...
	public RefactoringPage4(WebDriver driver) {
		super(Constants.LOGO_4, driver);
	}

	public static BaseRefactoringPage initialize(WebDriver webDriver) {
		RefactoringPage4 page = WrappedPageFactory.initElements(webDriver, RefactoringPage4.class);
