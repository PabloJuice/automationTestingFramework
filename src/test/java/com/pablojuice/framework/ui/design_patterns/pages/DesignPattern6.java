...
public class DesignPattern6 extends BaseDesignPattern {
	...
	public DesignPattern6(WebDriver driver) {
		super(Constants.LOGO_6, driver);
	}

	public static BaseDesignPattern initialize(WebDriver webDriver) {
		DesignPattern6 page = WrappedPageFactory.initElements(webDriver, DesignPattern6.class);
