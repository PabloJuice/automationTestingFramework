...
public class DesignPattern3 extends BaseDesignPattern {
	...
	public DesignPattern3(WebDriver driver) {
		super(Constants.LOGO_3, driver);
	}

	public static BaseDesignPattern initialize(WebDriver webDriver) {
		DesignPattern3 page = WrappedPageFactory.initElements(webDriver, DesignPattern3.class);
